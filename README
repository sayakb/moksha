...
Moksha is a powerful site building utility that makes your life easy!
 ...
 - You can create a new site from a central administration panel by simply entering
   the new URL (and pointing your apache configuration to your Moksha's installation
   directory).
 - Creating pages involve merely dragging and dropping controls (HTML elements) and
   selecting any data source to bind to them from a menu.
