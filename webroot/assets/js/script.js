...
! function (e) {
	...
	e(function () {
		e("html").on("click.dropdown.data-api touchstart.dropdown.data-api", c);
		e("body").on("click.dropdown touchstart.dropdown.data-api", ".dropdown form", function (f) {
			f.stopPropagation()
...
! function (a) {
	...
	b.prototype = {
		...
		listen: function () {
			...
			if (a.browser.chrome || a.browser.webkit || a.browser.msie) {
